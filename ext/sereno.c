 ...
 *
 * Este programa se distribuye con la sondeanza de que sea √∫til,
 * pero SIN NINGUNA GARANTIA; ni siquiera la garant√≠a impl√≠cita de
 * COMERCIABILIDAD o APTITUD PARA UN PROP√ìSITO DETERMINADO. Vea la
 * Licencia P√∫blica General de GNU para m√°s detalles.
 *
 * Deber√≠as haber recibido una copia de la Licencia P√∫blica General
...
/* haz_sondea  -- Proporciona funciÛn pol() cargada din·micamente */
...
/* haz_vigila -- Proporciona funciÛn select() cargada din·micamente */
...
#endif
{
    ...
    /* SÛlo acept 1 argumento */
    if (nargs != 1) {
        lintwarn(ext_id, "vigila: n∫ e argumentos incorrecto");
        return make_number(-1, resultado);
    }
    ...
    /* Limpia colecci√≥n de descriptores E/S */
    FD_ZERO(&dsc_lect);
    FD_ZERO(&dsc_escr);
